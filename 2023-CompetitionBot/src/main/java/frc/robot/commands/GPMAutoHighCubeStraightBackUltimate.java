...
public class GPMAutoHighCubeStraightBackUltimate extends SequentialCommandGroup {
  /** Creates a new GPMAutoHighCubeStraightBackUltimate. */
  public GPMAutoHighCubeStraightBackUltimate() {
