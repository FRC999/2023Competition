...
public class GPMAutoPlaceElementMiddleHighNoFlip extends SequentialCommandGroup {
  /** Creates a new GPMAutoPlaceElementMiddleHighNoFlip. */
  public GPMAutoPlaceElementMiddleHighNoFlip() {
