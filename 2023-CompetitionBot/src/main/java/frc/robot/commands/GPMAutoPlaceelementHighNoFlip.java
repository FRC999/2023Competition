...
public class GPMAutoPlaceelementHighNoFlip extends SequentialCommandGroup {
  /** Creates a new GPMAutoPlaceelementHighNoFlip. */
  public GPMAutoPlaceelementHighNoFlip() {
