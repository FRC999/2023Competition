...
public class GPMAutoPlaceElementLow extends SequentialCommandGroup {
  /** Creates a new GPMAutoPlaceElementLow.
   *  Auto-Placing element in a lower low
   */
  public GPMAutoPlaceElementLow() {
