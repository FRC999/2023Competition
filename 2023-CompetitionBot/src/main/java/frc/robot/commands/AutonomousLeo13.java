...
public class AutonomousLeo13 extends SequentialCommandGroup {
  ...
  */
  public AutonomousLeo13() {
    ...
    addCommands(
      ...
      new FlipperUp(),
      new WaitCommand(0.1),
      new RunTrajectorySequenceRobotAtStartPoint("LeoBlue",false) //I don't think we need to keep this as false...
      //new GPMAutoFarConeStraightFront()
    );
  }
}
